...
export default function NeonOrbsHero() {
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden flex items-center justify-center" style={{ background: 'linear-gradient(135deg, #0A1628 0%, #1E3A5F 100%)' }}>
      ...
      <div className="relative z-10 text-center">
        <h1 
          className={`text-4xl md:text-7xl font-extralight tracking-[0.2em] mb-4 transition-all duration-1000 ease-out ${mounted ? "opacity-100 translate-y-0 blur-0" : "opacity-0 translate-y-8 blur-sm"}`} 
          style={{
        ...
        <p 
          className={`text-lg md:text-xl font-light tracking-widest transition-all duration-1000 ease-out ${mounted ? "opacity-100 translate-y-0 blur-0" : "opacity-0 translate-y-4 blur-sm"}`} 
          style={{
