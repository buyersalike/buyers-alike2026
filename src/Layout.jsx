...
export default function Layout({ children, currentPageName }) {
  ...
  const appPages = ["Partnerships", "PartnershipManagement", "Opportunities", "OpportunityDetail", "Recommendations", "Vendors", "Messages", "Forum", "PostDetail", "News", "Profile", "Settings", "ActivityFeed", "AdCampaigns", "Admin"];
